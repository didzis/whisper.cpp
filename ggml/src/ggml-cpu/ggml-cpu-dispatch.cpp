...
GGML_BACKEND_API void    x64_ggml_numa_init(enum ggml_numa_strategy numa); // call once for better performance on NUMA systems
GGML_BACKEND_API bool    x64_ggml_is_numa(void); // true if init detected that system has >1 NUMA node

GGML_BACKEND_API struct ggml_tensor * x64_ggml_new_i32(struct ggml_context * ctx, int32_t value);
GGML_BACKEND_API struct ggml_tensor * x64_ggml_new_f32(struct ggml_context * ctx, float value);

GGML_BACKEND_API struct ggml_tensor * x64_ggml_set_i32 (struct ggml_tensor * tensor, int32_t value);
GGML_BACKEND_API struct ggml_tensor * x64_ggml_set_f32 (struct ggml_tensor * tensor, float value);

GGML_BACKEND_API int32_t x64_ggml_get_i32_1d(const struct ggml_tensor * tensor, int i);
GGML_BACKEND_API void    x64_ggml_set_i32_1d(const struct ggml_tensor * tensor, int i, int32_t value);

GGML_BACKEND_API int32_t x64_ggml_get_i32_nd(const struct ggml_tensor * tensor, int i0, int i1, int i2, int i3);
GGML_BACKEND_API void    x64_ggml_set_i32_nd(const struct ggml_tensor * tensor, int i0, int i1, int i2, int i3, int32_t value);

GGML_BACKEND_API float   x64_ggml_get_f32_1d(const struct ggml_tensor * tensor, int i);
GGML_BACKEND_API void    x64_ggml_set_f32_1d(const struct ggml_tensor * tensor, int i, float value);

GGML_BACKEND_API float   x64_ggml_get_f32_nd(const struct ggml_tensor * tensor, int i0, int i1, int i2, int i3);
GGML_BACKEND_API void    x64_ggml_set_f32_nd(const struct ggml_tensor * tensor, int i0, int i1, int i2, int i3, float value);

GGML_BACKEND_API struct ggml_threadpool *      x64_ggml_threadpool_new           (struct ggml_threadpool_params  * params);
GGML_BACKEND_API void                          x64_ggml_threadpool_free          (struct ggml_threadpool * threadpool);
// GGML_BACKEND_API int                           x64_ggml_threadpool_get_n_threads (struct ggml_threadpool * threadpool);
GGML_BACKEND_API void                          x64_ggml_threadpool_pause         (struct ggml_threadpool * threadpool);
GGML_BACKEND_API void                          x64_ggml_threadpool_resume        (struct ggml_threadpool * threadpool);

GGML_BACKEND_API struct ggml_cplan x64_ggml_graph_plan(
              const struct ggml_cgraph * cgraph,
                                   int   n_threads, /* = GGML_DEFAULT_N_THREADS */
                struct ggml_threadpool * threadpool /* = NULL */ );
GGML_BACKEND_API enum ggml_status  x64_ggml_graph_compute(struct ggml_cgraph * cgraph, struct ggml_cplan * cplan);

GGML_BACKEND_API enum ggml_status  x64_ggml_graph_compute_with_ctx(struct ggml_context * ctx, struct ggml_cgraph * cgraph, int n_threads);



GGML_BACKEND_API const struct ggml_type_traits_cpu * x64_ggml_get_type_traits_cpu(enum ggml_type type);

GGML_BACKEND_API void x64_ggml_cpu_init(void);

//
// CPU backend
//

GGML_BACKEND_API ggml_backend_t x64_ggml_backend_cpu_init(void);

GGML_BACKEND_API bool x64_ggml_backend_is_cpu                (ggml_backend_t backend);
GGML_BACKEND_API void x64_ggml_backend_cpu_set_n_threads     (ggml_backend_t backend_cpu, int n_threads);
GGML_BACKEND_API void x64_ggml_backend_cpu_set_threadpool    (ggml_backend_t backend_cpu, ggml_threadpool_t threadpool);
GGML_BACKEND_API void x64_ggml_backend_cpu_set_abort_callback(ggml_backend_t backend_cpu, ggml_abort_callback abort_callback, void * abort_callback_data);

GGML_BACKEND_API ggml_backend_reg_t x64_ggml_backend_cpu_reg(void);

GGML_BACKEND_API void x64_ggml_cpu_fp32_to_fp16(const float *, ggml_fp16_t *, int64_t);
GGML_BACKEND_API void x64_ggml_cpu_fp16_to_fp32(const ggml_fp16_t *, float *, int64_t);
GGML_BACKEND_API void x64_ggml_cpu_fp32_to_bf16(const float *, ggml_bf16_t *, int64_t);
GGML_BACKEND_API void x64_ggml_cpu_bf16_to_fp32(const ggml_bf16_t *, float *, int64_t);
...
GGML_BACKEND_API void    sse42_ggml_numa_init(enum ggml_numa_strategy numa); // call once for better performance on NUMA systems
GGML_BACKEND_API bool    sse42_ggml_is_numa(void); // true if init detected that system has >1 NUMA node

GGML_BACKEND_API struct ggml_tensor * sse42_ggml_new_i32(struct ggml_context * ctx, int32_t value);
GGML_BACKEND_API struct ggml_tensor * sse42_ggml_new_f32(struct ggml_context * ctx, float value);

GGML_BACKEND_API struct ggml_tensor * sse42_ggml_set_i32 (struct ggml_tensor * tensor, int32_t value);
GGML_BACKEND_API struct ggml_tensor * sse42_ggml_set_f32 (struct ggml_tensor * tensor, float value);

GGML_BACKEND_API int32_t sse42_ggml_get_i32_1d(const struct ggml_tensor * tensor, int i);
GGML_BACKEND_API void    sse42_ggml_set_i32_1d(const struct ggml_tensor * tensor, int i, int32_t value);

GGML_BACKEND_API int32_t sse42_ggml_get_i32_nd(const struct ggml_tensor * tensor, int i0, int i1, int i2, int i3);
GGML_BACKEND_API void    sse42_ggml_set_i32_nd(const struct ggml_tensor * tensor, int i0, int i1, int i2, int i3, int32_t value);

GGML_BACKEND_API float   sse42_ggml_get_f32_1d(const struct ggml_tensor * tensor, int i);
GGML_BACKEND_API void    sse42_ggml_set_f32_1d(const struct ggml_tensor * tensor, int i, float value);

GGML_BACKEND_API float   sse42_ggml_get_f32_nd(const struct ggml_tensor * tensor, int i0, int i1, int i2, int i3);
GGML_BACKEND_API void    sse42_ggml_set_f32_nd(const struct ggml_tensor * tensor, int i0, int i1, int i2, int i3, float value);

GGML_BACKEND_API struct ggml_threadpool *      sse42_ggml_threadpool_new           (struct ggml_threadpool_params  * params);
GGML_BACKEND_API void                          sse42_ggml_threadpool_free          (struct ggml_threadpool * threadpool);
// GGML_BACKEND_API int                           sse42_ggml_threadpool_get_n_threads (struct ggml_threadpool * threadpool);
GGML_BACKEND_API void                          sse42_ggml_threadpool_pause         (struct ggml_threadpool * threadpool);
GGML_BACKEND_API void                          sse42_ggml_threadpool_resume        (struct ggml_threadpool * threadpool);

GGML_BACKEND_API struct ggml_cplan sse42_ggml_graph_plan(
              const struct ggml_cgraph * cgraph,
                                   int   n_threads, /* = GGML_DEFAULT_N_THREADS */
                struct ggml_threadpool * threadpool /* = NULL */ );
GGML_BACKEND_API enum ggml_status  sse42_ggml_graph_compute(struct ggml_cgraph * cgraph, struct ggml_cplan * cplan);

GGML_BACKEND_API enum ggml_status  sse42_ggml_graph_compute_with_ctx(struct ggml_context * ctx, struct ggml_cgraph * cgraph, int n_threads);



GGML_BACKEND_API const struct ggml_type_traits_cpu * sse42_ggml_get_type_traits_cpu(enum ggml_type type);

GGML_BACKEND_API void sse42_ggml_cpu_init(void);

//
// CPU backend
//

GGML_BACKEND_API ggml_backend_t sse42_ggml_backend_cpu_init(void);

GGML_BACKEND_API bool sse42_ggml_backend_is_cpu                (ggml_backend_t backend);
GGML_BACKEND_API void sse42_ggml_backend_cpu_set_n_threads     (ggml_backend_t backend_cpu, int n_threads);
GGML_BACKEND_API void sse42_ggml_backend_cpu_set_threadpool    (ggml_backend_t backend_cpu, ggml_threadpool_t threadpool);
GGML_BACKEND_API void sse42_ggml_backend_cpu_set_abort_callback(ggml_backend_t backend_cpu, ggml_abort_callback abort_callback, void * abort_callback_data);

GGML_BACKEND_API ggml_backend_reg_t sse42_ggml_backend_cpu_reg(void);

GGML_BACKEND_API void sse42_ggml_cpu_fp32_to_fp16(const float *, ggml_fp16_t *, int64_t);
GGML_BACKEND_API void sse42_ggml_cpu_fp16_to_fp32(const ggml_fp16_t *, float *, int64_t);
GGML_BACKEND_API void sse42_ggml_cpu_fp32_to_bf16(const float *, ggml_bf16_t *, int64_t);
GGML_BACKEND_API void sse42_ggml_cpu_bf16_to_fp32(const ggml_bf16_t *, float *, int64_t);
...
GGML_BACKEND_API void sandybridge_ggml_cpu_fp32_to_fp16(const float *, ggml_fp16_t *, int64_t);
GGML_BACKEND_API void sandybridge_ggml_cpu_fp16_to_fp32(const ggml_fp16_t *, float *, int64_t);
GGML_BACKEND_API void sandybridge_ggml_cpu_fp32_to_bf16(const float *, ggml_bf16_t *, int64_t);
GGML_BACKEND_API void sandybridge_ggml_cpu_bf16_to_fp32(const ggml_bf16_t *, float *, int64_t);
...
GGML_BACKEND_API void haswell_ggml_cpu_fp32_to_fp16(const float *, ggml_fp16_t *, int64_t);
GGML_BACKEND_API void haswell_ggml_cpu_fp16_to_fp32(const ggml_fp16_t *, float *, int64_t);
GGML_BACKEND_API void haswell_ggml_cpu_fp32_to_bf16(const float *, ggml_bf16_t *, int64_t);
GGML_BACKEND_API void haswell_ggml_cpu_bf16_to_fp32(const ggml_bf16_t *, float *, int64_t);
...
GGML_BACKEND_API void skylakex_ggml_cpu_fp32_to_fp16(const float *, ggml_fp16_t *, int64_t);
GGML_BACKEND_API void skylakex_ggml_cpu_fp16_to_fp32(const ggml_fp16_t *, float *, int64_t);
GGML_BACKEND_API void skylakex_ggml_cpu_fp32_to_bf16(const float *, ggml_bf16_t *, int64_t);
GGML_BACKEND_API void skylakex_ggml_cpu_bf16_to_fp32(const ggml_bf16_t *, float *, int64_t);
...
GGML_BACKEND_API void icelake_ggml_cpu_fp32_to_fp16(const float *, ggml_fp16_t *, int64_t);
GGML_BACKEND_API void icelake_ggml_cpu_fp16_to_fp32(const ggml_fp16_t *, float *, int64_t);
GGML_BACKEND_API void icelake_ggml_cpu_fp32_to_bf16(const float *, ggml_bf16_t *, int64_t);
GGML_BACKEND_API void icelake_ggml_cpu_bf16_to_fp32(const ggml_bf16_t *, float *, int64_t);
...
GGML_BACKEND_API void alderlake_ggml_cpu_fp32_to_fp16(const float *, ggml_fp16_t *, int64_t);
GGML_BACKEND_API void alderlake_ggml_cpu_fp16_to_fp32(const ggml_fp16_t *, float *, int64_t);
GGML_BACKEND_API void alderlake_ggml_cpu_fp32_to_bf16(const float *, ggml_bf16_t *, int64_t);
GGML_BACKEND_API void alderlake_ggml_cpu_bf16_to_fp32(const ggml_bf16_t *, float *, int64_t);
...
GGML_BACKEND_API void sapphirerapids_ggml_cpu_fp32_to_fp16(const float *, ggml_fp16_t *, int64_t);
GGML_BACKEND_API void sapphirerapids_ggml_cpu_fp16_to_fp32(const ggml_fp16_t *, float *, int64_t);
GGML_BACKEND_API void sapphirerapids_ggml_cpu_fp32_to_bf16(const float *, ggml_bf16_t *, int64_t);
GGML_BACKEND_API void sapphirerapids_ggml_cpu_bf16_to_fp32(const ggml_bf16_t *, float *, int64_t);
...
void ggml_select_cpu_backend() {
    ...
    if (false) {
        ...
        ggml_cpu_fp32_to_fp16 = sapphirerapids_ggml_cpu_fp32_to_fp16;
        ggml_cpu_fp16_to_fp32 = sapphirerapids_ggml_cpu_fp16_to_fp32;
        ggml_cpu_fp32_to_bf16 = sapphirerapids_ggml_cpu_fp32_to_bf16;
        ggml_cpu_bf16_to_fp32 = sapphirerapids_ggml_cpu_bf16_to_fp32;
        ...
        ggml_cpu_fp32_to_fp16 = icelake_ggml_cpu_fp32_to_fp16;
        ggml_cpu_fp16_to_fp32 = icelake_ggml_cpu_fp16_to_fp32;
        ...
        ggml_cpu_fp32_to_fp16 = skylakex_ggml_cpu_fp32_to_fp16;
        ggml_cpu_fp16_to_fp32 = skylakex_ggml_cpu_fp16_to_fp32;
        ...
        ggml_cpu_fp32_to_fp16 = alderlake_ggml_cpu_fp32_to_fp16;
        ggml_cpu_fp16_to_fp32 = alderlake_ggml_cpu_fp16_to_fp32;
        ...
        ggml_cpu_fp32_to_fp16 = haswell_ggml_cpu_fp32_to_fp16;
        ggml_cpu_fp16_to_fp32 = haswell_ggml_cpu_fp16_to_fp32;
        ggml_cpu_fp32_to_bf16 = haswell_ggml_cpu_fp32_to_bf16;
        ggml_cpu_bf16_to_fp32 = haswell_ggml_cpu_bf16_to_fp32;
        ...
        ggml_cpu_fp32_to_fp16 = sandybridge_ggml_cpu_fp32_to_fp16;
        ggml_cpu_fp16_to_fp32 = sandybridge_ggml_cpu_fp16_to_fp32;
        ggml_cpu_fp32_to_bf16 = sandybridge_ggml_cpu_fp32_to_bf16;
        ggml_cpu_bf16_to_fp32 = sandybridge_ggml_cpu_bf16_to_fp32;

    } else if (sse42) {

        PRINTF("ggml_cpu_backend: selecting CPU backend: sse42\n");

        ggml_numa_init = sse42_ggml_numa_init;
        ggml_is_numa = sse42_ggml_is_numa;

        ggml_new_i32 = sse42_ggml_new_i32;
        ggml_new_f32 = sse42_ggml_new_f32;

        ggml_set_i32 = sse42_ggml_set_i32;
        ggml_set_f32 = sse42_ggml_set_f32;

        ggml_get_i32_1d = sse42_ggml_get_i32_1d;
        ggml_set_i32_1d = sse42_ggml_set_i32_1d;

        ggml_get_i32_nd = sse42_ggml_get_i32_nd;
        ggml_set_i32_nd = sse42_ggml_set_i32_nd;

        ggml_get_f32_1d = sse42_ggml_get_f32_1d;
        ggml_set_f32_1d = sse42_ggml_set_f32_1d;

        ggml_get_f32_nd = sse42_ggml_get_f32_nd;
        ggml_set_f32_nd = sse42_ggml_set_f32_nd;

        ggml_threadpool_new = sse42_ggml_threadpool_new;
        ggml_threadpool_free = sse42_ggml_threadpool_free;
        // ggml_threadpool_get_n_threads = sse42_ggml_threadpool_get_n_threads;
        ggml_threadpool_pause = sse42_ggml_threadpool_pause;
        ggml_threadpool_resume = sse42_ggml_threadpool_resume;

        ggml_graph_plan = sse42_ggml_graph_plan;
        ggml_graph_compute = sse42_ggml_graph_compute;
        ggml_graph_compute_with_ctx = sse42_ggml_graph_compute_with_ctx;

        ggml_get_type_traits_cpu = sse42_ggml_get_type_traits_cpu;

        _ggml_cpu_init = sse42_ggml_cpu_init;

        _ggml_backend_cpu_init = sse42_ggml_backend_cpu_init;

        ggml_backend_is_cpu = sse42_ggml_backend_is_cpu;
        ggml_backend_cpu_set_n_threads = sse42_ggml_backend_cpu_set_n_threads;
        ggml_backend_cpu_set_threadpool = sse42_ggml_backend_cpu_set_threadpool;
        ggml_backend_cpu_set_abort_callback = sse42_ggml_backend_cpu_set_abort_callback;

        _ggml_backend_cpu_reg = sse42_ggml_backend_cpu_reg;

        ggml_cpu_fp32_to_fp16 = sse42_ggml_cpu_fp32_to_fp16;
        ggml_cpu_fp16_to_fp32 = sse42_ggml_cpu_fp16_to_fp32;
        ggml_cpu_fp32_to_bf16 = sse42_ggml_cpu_fp32_to_bf16;
        ggml_cpu_bf16_to_fp32 = sse42_ggml_cpu_bf16_to_fp32;

    } else {

        PRINTF("ggml_cpu_backend: selecting CPU backend: x64\n");

        ggml_numa_init = x64_ggml_numa_init;
        ggml_is_numa = x64_ggml_is_numa;

        ggml_new_i32 = x64_ggml_new_i32;
        ggml_new_f32 = x64_ggml_new_f32;

        ggml_set_i32 = x64_ggml_set_i32;
        ggml_set_f32 = x64_ggml_set_f32;

        ggml_get_i32_1d = x64_ggml_get_i32_1d;
        ggml_set_i32_1d = x64_ggml_set_i32_1d;

        ggml_get_i32_nd = x64_ggml_get_i32_nd;
        ggml_set_i32_nd = x64_ggml_set_i32_nd;

        ggml_get_f32_1d = x64_ggml_get_f32_1d;
        ggml_set_f32_1d = x64_ggml_set_f32_1d;

        ggml_get_f32_nd = x64_ggml_get_f32_nd;
        ggml_set_f32_nd = x64_ggml_set_f32_nd;

        ggml_threadpool_new = x64_ggml_threadpool_new;
        ggml_threadpool_free = x64_ggml_threadpool_free;
        // ggml_threadpool_get_n_threads = x64_ggml_threadpool_get_n_threads;
        ggml_threadpool_pause = x64_ggml_threadpool_pause;
        ggml_threadpool_resume = x64_ggml_threadpool_resume;

        ggml_graph_plan = x64_ggml_graph_plan;
        ggml_graph_compute = x64_ggml_graph_compute;
        ggml_graph_compute_with_ctx = x64_ggml_graph_compute_with_ctx;

        ggml_get_type_traits_cpu = x64_ggml_get_type_traits_cpu;

        _ggml_cpu_init = x64_ggml_cpu_init;

        _ggml_backend_cpu_init = x64_ggml_backend_cpu_init;

        ggml_backend_is_cpu = x64_ggml_backend_is_cpu;
        ggml_backend_cpu_set_n_threads = x64_ggml_backend_cpu_set_n_threads;
        ggml_backend_cpu_set_threadpool = x64_ggml_backend_cpu_set_threadpool;
        ggml_backend_cpu_set_abort_callback = x64_ggml_backend_cpu_set_abort_callback;

        _ggml_backend_cpu_reg = x64_ggml_backend_cpu_reg;

        ggml_cpu_fp32_to_fp16 = x64_ggml_cpu_fp32_to_fp16;
        ggml_cpu_fp16_to_fp32 = x64_ggml_cpu_fp16_to_fp32;
        ggml_cpu_fp32_to_bf16 = x64_ggml_cpu_fp32_to_bf16;
        ggml_cpu_bf16_to_fp32 = x64_ggml_cpu_bf16_to_fp32;
